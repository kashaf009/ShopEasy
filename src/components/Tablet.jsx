        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {tablets.map((item) => {
            ...
            return (
              ...
              >
                {/* Image */}
                <Link to={`/product/${item.category || 'tablet'}/${id}`} className="relative aspect-video w-full overflow-hidden bg-slate-50 block">
                  <img
                ...
                <div className="p-5 flex-1 flex flex-col justify-between">
                  <div>
                    <Link to={`/product/${item.category || 'tablet'}/${id}`}>
                      <h4
